...
btn_add = Button(root,text='+',bg='#FFC300',fg='white',width=5,height=2,command=lambda :get_operator('+'))
...
btn_sub = Button(root,text='-',bg='#FFC300',fg='white',width=5,height=2,command=lambda :get_operator('-'))
...
btn_mul = Button(root,text='*',bg='#FFC300',fg='white',width=5,height=2,command=lambda :get_operator('*'))
...
btn_equals = Button(root,text='=',bg='#FFC300',fg='white',width=5,height=2,command=get_result)
btn_equals.grid(row=4,column=2)
btn_equals.config(font=('verdana',14))

btn_div = Button(root,text='/',bg='#FFC300',fg='white',width=5,height=2,command=lambda :get_operator('/'))
